# Contributing to Flight Configure

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Configure? Welcome! Please read this
...
You can help Flight Configure by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-configure/issues?state=open)
...
If you find a bug - behaviour of Flight Configure code or documentation
...
[GitHub issue tracker for Flight Configure](https://github.com/openflighthpc/flight-configure/issues/new)
to report the issue.
...
We want to improve the quality of Flight Configure and good bug reports are
...
Flight Configure is Open Source and comes without warranty.
...
Flight Configure in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Configure and really improve it. The more
...
applied to Flight Configure itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-configure). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Configure developers also have their regular
